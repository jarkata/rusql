...
fn expand_derive_encode_transparent(
    ...
    generics
        .params
        .insert(0, parse_quote!(DB: ::rusql::Database));
    generics
        .make_where_clause()
        .predicates
        .push(parse_quote!(#ty: ::rusql::encode::Encode<#lifetime, DB>));
    let (impl_generics, _, where_clause) = generics.split_for_impl();

    Ok(quote!(
        #[automatically_derived]
        impl #impl_generics ::rusql::encode::Encode<#lifetime, DB> for #ident #ty_generics
        #where_clause
        {
            fn encode_by_ref(
                &self,
                buf: &mut <DB as ::rusql::database::HasArguments<#lifetime>>::ArgumentBuffer,
            ) -> ::rusql::encode::IsNull {
                <#ty as ::rusql::encode::Encode<#lifetime, DB>>::encode_by_ref(&self.0, buf)
            }

            fn produces(&self) -> Option<DB::TypeInfo> {
                <#ty as ::rusql::encode::Encode<#lifetime, DB>>::produces(&self.0)
            }

            fn size_hint(&self) -> usize {
                <#ty as ::rusql::encode::Encode<#lifetime, DB>>::size_hint(&self.0)
            }
        }
    ))
}
...
fn expand_derive_encode_weak_enum(
    ...
    Ok(quote!(
        #[automatically_derived]
        impl<'q, DB: ::rusql::Database> ::rusql::encode::Encode<'q, DB> for #ident
        where
            #repr: ::rusql::encode::Encode<'q, DB>,
        {
            fn encode_by_ref(
                &self,
                buf: &mut <DB as ::rusql::database::HasArguments<'q>>::ArgumentBuffer,
            ) -> ::rusql::encode::IsNull {
                let value = match self {
                    #(#values)*
                };

                <#repr as ::rusql::encode::Encode<DB>>::encode_by_ref(&value, buf)
            }

            fn size_hint(&self) -> usize {
                <#repr as ::rusql::encode::Encode<DB>>::size_hint(&Default::default())
            }
        }
    ))
}
...
fn expand_derive_encode_strong_enum(
    ...
    Ok(quote!(
        ...
        impl<'q, DB: ::rusql::Database> ::rusql::encode::Encode<'q, DB> for #ident
        where
            &'q ::std::primitive::str: ::rusql::encode::Encode<'q, DB>,
        {
            fn encode_by_ref(
                &self,
                buf: &mut <DB as ::rusql::database::HasArguments<'q>>::ArgumentBuffer,
                ...
                <&::std::primitive::str as ::rusql::encode::Encode<'q, DB>>::encode(val, buf)
            }
            ...
            fn size_hint(&self) -> ::std::primitive::usize {
                ...
                <&::std::primitive::str as ::rusql::encode::Encode<'q, DB>>::size_hint(&val)
            }
        }
    ))
}
...
fn expand_derive_encode_struct(
    ...
    if cfg!(feature = "postgres") {
        ...
        for field in fields {
            ...
            predicates
                .push(parse_quote!(#ty: for<'q> ::rusql::encode::Encode<'q, ::rusql::Postgres>));
            predicates.push(parse_quote!(#ty: ::rusql::types::Type<::rusql::Postgres>));
        }
        ...
        let sizes = fields.iter().map(|field| -> Expr {
            ...
            parse_quote!(
                <#ty as ::rusql::encode::Encode<::rusql::Postgres>>::size_hint(&self. #id)
            )
        });

        tts.extend(quote!(
            #[automatically_derived]
            impl #impl_generics ::rusql::encode::Encode<'_, ::rusql::Postgres> for #ident #ty_generics
            #where_clause
            {
                fn encode_by_ref(
                    &self,
                    buf: &mut ::rusql::postgres::PgArgumentBuffer,
                ) -> ::rusql::encode::IsNull {
                    let mut encoder = ::rusql::postgres::types::PgRecordEncoder::new(buf);

                    #(#writes)*

                    encoder.finish();

                    ::rusql::encode::IsNull::No
                }
