...
fn expand_derive_has_sql_type_transparent(
    ...
    if attr.transparent {
        ...
        generics
            .make_where_clause()
            .predicates
            .push(parse_quote!(#ty: ::rusql::Type<DB>));
        let (impl_generics, _, where_clause) = generics.split_for_impl();

        array_generics
            .make_where_clause()
            .predicates
            .push(parse_quote!(#ty: ::rusql::postgres::PgHasArrayType));
        let (array_impl_generics, _, array_where_clause) = array_generics.split_for_impl();

        return Ok(quote!(
            #[automatically_derived]
            impl #impl_generics ::rusql::Type< DB > for #ident #ty_generics #where_clause {
                fn type_info() -> DB::TypeInfo {
                    <#ty as ::rusql::Type<DB>>::type_info()
                }

                fn compatible(ty: &DB::TypeInfo) -> ::std::primitive::bool {
                    <#ty as ::rusql::Type<DB>>::compatible(ty)
                }
            }
            #[automatically_derived]
            #[cfg(feature = "postgres")]
            impl #array_impl_generics ::rusql::postgres::PgHasArrayType for #ident #ty_generics
            #array_where_clause {
                fn array_type_info() -> ::rusql::postgres::PgTypeInfo {
                    <#ty as ::rusql::postgres::PgHasArrayType>::array_type_info()
                }
            }
        ));
    }
    ...
    if cfg!(feature = "postgres") {
        ...
        tts.extend(quote!(
            #[automatically_derived]
            impl ::rusql::Type<::rusql::postgres::Postgres> for #ident #ty_generics {
                fn type_info() -> ::rusql::postgres::PgTypeInfo {
                    ::rusql::postgres::PgTypeInfo::with_name(#ty_name)
                }
            }
        ));
    }
...
fn expand_derive_has_sql_type_weak_enum(
    ...
    let ts = quote!(
        #[automatically_derived]
        impl<DB: ::rusql::Database> ::rusql::Type<DB> for #ident
        where
            #repr: ::rusql::Type<DB>,
        {
            fn type_info() -> DB::TypeInfo {
                <#repr as ::rusql::Type<DB>>::type_info()
            }

            fn compatible(ty: &DB::TypeInfo) -> bool {
                <#repr as ::rusql::Type<DB>>::compatible(ty)
            }
        }
    );
...
fn expand_derive_has_sql_type_strong_enum(
    ...
    if cfg!(feature = "mysql") {
        tts.extend(quote!(
            #[automatically_derived]
            impl ::rusql::Type<::rusql::MySql> for #ident {
                fn type_info() -> ::rusql::mysql::MySqlTypeInfo {
                    ::rusql::mysql::MySqlTypeInfo::__enum()
                }

                fn compatible(ty: &::rusql::mysql::MySqlTypeInfo) -> ::std::primitive::bool {
                    *ty == ::rusql::mysql::MySqlTypeInfo::__enum()
                }
            }
        ));
    }
    ...
    if cfg!(feature = "postgres") {
        ...
        tts.extend(quote!(
            #[automatically_derived]
            impl ::rusql::Type<::rusql::Postgres> for #ident {
                fn type_info() -> ::rusql::postgres::PgTypeInfo {
                    ::rusql::postgres::PgTypeInfo::with_name(#ty_name)
                }
            }
    ...
    if cfg!(feature = "sqlite") {
        tts.extend(quote!(
            #[automatically_derived]
            impl rusql::Type<::rusql::Sqlite> for #ident {
                fn type_info() -> ::rusql::sqlite::SqliteTypeInfo {
                    <::std::primitive::str as ::rusql::Type<rusql::Sqlite>>::type_info()
                }

                fn compatible(ty: &::rusql::sqlite::SqliteTypeInfo) -> ::std::primitive::bool {
                    <&::std::primitive::str as ::rusql::types::Type<rusql::sqlite::Sqlite>>::compatible(ty)
                }
            }
        ));
    }
