...
fn expand_derive_decode_transparent(
    ...
    generics
        .make_where_clause()
        .predicates
        .push(parse_quote!(#ty: ::rusql::decode::Decode<'r, DB>));
    let (impl_generics, _, where_clause) = generics.split_for_impl();

    let tts = quote!(
        #[automatically_derived]
        impl #impl_generics ::rusql::decode::Decode<'r, DB> for #ident #ty_generics #where_clause {
            fn decode(
                value: <DB as ::rusql::database::HasValueRef<'r>>::ValueRef,
            ) -> ::std::result::Result<
                Self,
                ::std::boxed::Box<
                ...
                >,
            > {
                <#ty as ::rusql::decode::Decode<'r, DB>>::decode(value).map(Self)
            }
        }
    );
...
fn expand_derive_decode_weak_enum(
    ...
    Ok(quote!(
        #[automatically_derived]
        impl<'r, DB: ::rusql::Database> ::rusql::decode::Decode<'r, DB> for #ident
        where
            #repr: ::rusql::decode::Decode<'r, DB>,
        {
            fn decode(
                value: <DB as ::rusql::database::HasValueRef<'r>>::ValueRef,
            ) -> ::std::result::Result<
                ...
                >,
            > {
                let value = <#repr as ::rusql::decode::Decode<'r, DB>>::decode(value)?;

                match value {
                    #(#arms)*
                    _ => ::std::result::Result::Err(::std::boxed::Box::new(::rusql::Error::Decode(
...
fn expand_derive_decode_strong_enum(
    ...
    if cfg!(feature = "mysql") {
        tts.extend(quote!(
            #[automatically_derived]
            impl<'r> ::rusql::decode::Decode<'r, ::rusql::mysql::MySql> for #ident {
                fn decode(
                    value: ::rusql::mysql::MySqlValueRef<'r>,
                ) -> ::std::result::Result<
                    Self,
                    ::std::boxed::Box<
                        dyn ::std::error::Error
                    ...
                    >,
                > {
                    let value = <&'r ::std::primitive::str as ::rusql::decode::Decode<
                        'r,
                        ::rusql::mysql::MySql,
                    >>::decode(value)?;
    ...
    if cfg!(feature = "postgres") {
        tts.extend(quote!(
            #[automatically_derived]
            impl<'r> ::rusql::decode::Decode<'r, ::rusql::postgres::Postgres> for #ident {
                fn decode(
                    value: ::rusql::postgres::PgValueRef<'r>,
                ) -> ::std::result::Result<
                    Self,
                    ::std::boxed::Box<
                        dyn ::std::error::Error
    ...
    if cfg!(feature = "sqlite") {
        tts.extend(quote!(
            #[automatically_derived]
            impl<'r> ::rusql::decode::Decode<'r, ::rusql::sqlite::Sqlite> for #ident {
                fn decode(
                    value: ::rusql::sqlite::SqliteValueRef<'r>,
                ) -> ::std::result::Result<
                    Self,
                    ::std::boxed::Box<
                        dyn ::std::error::Error
...
fn expand_derive_decode_struct(
    ...
    if cfg!(feature = "postgres") {
        ...
        for field in fields {
            ...
            predicates.push(parse_quote!(#ty: ::rusql::decode::Decode<'r, ::rusql::Postgres>));
        ...
        tts.extend(quote!(
            #[automatically_derived]
            impl #impl_generics ::rusql::decode::Decode<'r, ::rusql::Postgres> for #ident #ty_generics
            #where_clause
            {
                fn decode(
                    value: ::rusql::postgres::PgValueRef<'r>,
                    ...
                    >,
                > {
                    let mut decoder = ::rusql::postgres::types::PgRecordDecoder::new(value)?;
