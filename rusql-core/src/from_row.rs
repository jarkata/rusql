...
/// ## Derivable
///
/// This trait can be derived by RuSQL for any struct. The generated implementation
...
///
/// ```rust,ignore
/// use rusql::{FromRow, sqlite::SqliteRow, rusql::Row};
/// struct MyCustomType {
///     custom: String,
/// }
///
...
///     fn from_row(row: &SqliteRow) -> rusql::Result<Self> {
///         Ok(Self {
///             bar: MyCustomType {
