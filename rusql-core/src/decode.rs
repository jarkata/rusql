...
///
/// ```rust
/// # use rusql_core::database::{Database, HasValueRef};
/// # use rusql_core::decode::Decode;
/// # use rusql_core::types::Type;
/// # use std::error::Error;
/// #
/// struct MyType;
///
...
/// # type Err = rusql_core::error::Error;
