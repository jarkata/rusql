//! Types for working with errors produced by RuSQL.
...
/// A specialized `Result` type for RuSQL.
pub type Result<T> = StdResult<T, Error>;

// Convenience type alias for usage within RuSQL.
...
/// Represents all the ways a method can fail within RuSQL.
...
pub enum Error {
    ...
    ///
    /// This should indicate there is a programming error in a RuSQL driver or there
...
impl From<rusql_rt::native_tls::Error> for Error {
    #[inline]
    fn from(error: rusql_rt::native_tls::Error) -> Self {
