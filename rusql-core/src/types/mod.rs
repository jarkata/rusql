...
/// ## Derivable
///
/// This trait can be derived by RuSQL to support Rust-only wrapper types, enumerations, and (for
...
/// ##### Attributes
///
/// * `#[rusql(type_name = "<SQL type name>")]` on struct definition: instead of inferring the SQL
...
/// * `#[rusql(rename_all = "<strategy>")]` on struct definition: See [`derive docs in FromRow`](crate::from_row::FromRow#rename_all)
///
/// ### Enumeration
///
...
/// ```rust,ignore
/// #[derive(rusql::Type)]
/// #[rusql(type_name = "color")] // only for PostgreSQL to match a type definition
/// #[rusql(rename_all = "lowercase")]
...
/// ```rust,ignore
/// #[derive(rusql::Type)]
/// #[rusql(type_name = "interface_type")]
