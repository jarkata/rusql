...
///
/// [See our FAQ]: https://github.com/launchbadge/rusql/blob/master/FAQ.md#how-can-i-bind-an-array-to-a-values-clause-how-can-i-do-bulk-inserts
    ...
    DB: Database,
{
    ...
    /// [postgres-limit-issue]: https://github.com/launchbadge/rusql/issues/671#issuecomment-687043510
    ...
    /// ```rust
    /// # #[cfg(feature = "mysql")] {
    /// use rusql::{Execute, MySql, QueryBuilder};
