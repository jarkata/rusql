...
//! # `Any`
//!
//! Selecting a database driver is, by default, a compile-time decision. RuSQL is designed this way
...
//! let conn = AnyConnection::connect("postgres://localhost/rusql").await?;
//! ```
