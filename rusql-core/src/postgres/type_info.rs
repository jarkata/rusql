...
impl PgTypeInfo {
    /// Returns the corresponding `PgTypeInfo` if the OID is a built-in type and recognized by RuSQL.
...
impl PgType {
    /// Returns the corresponding `PgType` if the OID is a built-in type and recognized by RuSQL.
    pub(crate) fn try_from_oid(oid: Oid) -> Option<Self> {
        Some(match oid.0 {
            16 => PgType::Bool,
            17 => PgType::Bytea,
